...
API_KEY = 'fk-cPKUl-OqgVejUacLgRXxasPNOOwLLeczE10YzN4lrgw,' \
          'pk-this-is-a-real-free-pool-token-for-everyone'    # 可同时填写多个API-KEY，用英文逗号分割，例如API_KEY = "sk-openaikey1,sk-openaikey2,fkxxxx-api2dkey3,azure-apikey4"
# fk-cPKUl-OqgVejUacLgRXxasPNOOwLLeczE10YzN4lrgw,
